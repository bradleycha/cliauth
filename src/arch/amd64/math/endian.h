...
/*----------------------------------------------------------------------------*/
/* src/arch/amd64/math/endian.h - AMD64-specific endian declarations.         */
/*----------------------------------------------------------------------------*/

#ifndef _CLIAUTH_ARCH_AMD64_MATH_ENDIAN_H
#define _CLIAUTH_ARCH_AMD64_MATH_ENDIAN_H
/*----------------------------------------------------------------------------*/
...
/* not.                                                                       */
/*----------------------------------------------------------------------------*/
#define CLIAUTH_ARCH_AMD64_MATH_ENDIAN_SWAP_INT32_IS_OPTIMIZED\
   (\
      CLIAUTH_ARCH_AMD64_INSTRUCTION_SUPPORTED_BSWAP_R32\
   )
#define CLIAUTH_ARCH_AMD64_MATH_ENDIAN_SWAP_INT64_IS_OPTIMIZED\
   (\
...
/* cliauth_endian_convert_*() for more information.                           */
/*----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------*/
#endif /* _CLIAUTH_ARCH_AMD64_MATH_ENDIAN_H */

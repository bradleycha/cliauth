...
/*----------------------------------------------------------------------------*/
/* src/arch/ia32/math/endian.h - IA32-specific endian declarations.           */
/*----------------------------------------------------------------------------*/

#ifndef _CLIAUTH_ARCH_IA32_MATH_ENDIAN_H
#define _CLIAUTH_ARCH_IA32_MATH_ENDIAN_H
/*----------------------------------------------------------------------------*/
...
/* not.                                                                       */
/*----------------------------------------------------------------------------*/
#define CLIAUTH_ARCH_IA32_MATH_ENDIAN_SWAP_INT32_IS_OPTIMIZED\
   (\
      CLIAUTH_ARCH_IA32_INSTRUCTION_SUPPORTED_BSWAP_R32\
   )
#define CLIAUTH_ARCH_IA32_MATH_ENDIAN_SWAP_INT64_IS_OPTIMIZED\
   (\
      CLIAUTH_ARCH_IA32_INSTRUCTION_SUPPORTED_BSWAP_R32\
   )
...
/*----------------------------------------------------------------------------*/
#endif /* _CLIAUTH_ARCH_IA32_MATH_ENDIAN_H */

...
/*----------------------------------------------------------------------------*/
/* src/cliauth/database/account.h - Individual database account header.       */
/*----------------------------------------------------------------------------*/

#ifndef _CLIAUTH_DATABASE_ACCOUNT_H
#define _CLIAUTH_DATABASE_ACCOUNT_H
/*----------------------------------------------------------------------------*/
...
union CliAuthDatabaseAccountAlgorithmParameters {
   ...
   struct CliAuthDatabaseAccountAlgorithmTotp totp;
};
...
struct CliAuthDatabaseAccountAlgorithm {
   ...
   union CliAuthDatabaseAccountAlgorithmParameters parameters;
};
...
/*----------------------------------------------------------------------------*/
#define CLIAUTH_DATABASE_ACCOUNT_DEFAULT_HASH_IS_AVAILABLE\
   CLIAUTH_CONFIG_CRYPTO_HASH_SHA1

/*----------------------------------------------------------------------------*/
/* Default values for various account fields.                                 */
/*----------------------------------------------------------------------------*/
#if CLIAUTH_DATABASE_ACCOUNT_DEFAULT_HASH_IS_AVAILABLE
#define CLIAUTH_DATABASE_ACCOUNT_DEFAULT_HASH_FUNCTION\
   (&cliauth_crypto_hash_sha1)
#define CLIAUTH_DATABASE_ACCOUNT_DEFAULT_HASH_IDENTIFIER\
   CLIAUTH_CRYPTO_HASH_SHA1_IDENTIFIER
#endif /* CLIAUTH_DATABASE_ACCOUNT_DEFAULT_HASH_IS_AVAILABLE */
#define CLIAUTH_DATABASE_ACCOUNT_DEFAULT_DIGITS\
   6u
#define CLIAUTH_DATABASE_ACCOUNT_DEFAULT_TOTP_PERIOD_HWORD0\
   0u
#define CLIAUTH_DATABASE_ACCOUNT_DEFAULT_TOTP_PERIOD_HWORD1\
   30u

/*----------------------------------------------------------------------------*/
/* Buffer lengths for account array fields.                                   */
/*----------------------------------------------------------------------------*/
#define CLIAUTH_DATABASE_ACCOUNT_SECRETS_MAX_LENGTH\
   128u
#define CLIAUTH_DATABASE_ACCOUNT_ISSUER_MAX_LENGTH\
   64u
#define CLIAUTH_DATABASE_ACCOUNT_ACCOUNT_NAME_MAX_LENGTH\
   64u
...
struct CliAuthDatabaseAccount {
   ...
   CliAuthUInt8 secrets [CLIAUTH_DATABASE_ACCOUNT_SECRETS_MAX_LENGTH];
   char issuer [CLIAUTH_DATABASE_ACCOUNT_ISSUER_MAX_LENGTH];
   char name [CLIAUTH_DATABASE_ACCOUNT_ACCOUNT_NAME_MAX_LENGTH];
...
/*----------------------------------------------------------------------------*/
#endif /* _CLIAUTH_DATABASE_ACCOUNT_H */

...
/*----------------------------------------------------------------------------*/
/* src/cliauth/ui/args.h - Command-line arguments parsing header.             */
/*----------------------------------------------------------------------------*/
...
/*    One or more required arguments were missing.                            */
/*                                                                            */
/* CLIAUTH_UI_ARGS_PARSE_RESULT_INVALID -                                     */
/*    One or more arguments were given an invalid value.                      */
/*----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------*/
/* account -                                                                  */
/*    The parsed authenticator account.                                       */
/*                                                                            */
/* totp_parameters -                                                          */
/*    TOTP-specific algorithm parameters.  This will only be valid when the   */
/*    account's authenticator algorithm type is                               */
/*    'CLIAUTH_DATABASE_ACCOUNT_ALGORITHM_TYPE_TOTP'.                         */
/*                                                                            */
/* index -                                                                    */
/*    The password index to generate, relative to the currently valid         */
/*    password.  See the documentation for                                    */
/*    'cliauth_database_account_generate_password()' for more information.    */
/*----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------*/
/* payload -                                                                  */
/*    A pointer to a CliAuthUiArgsPayload struct where the final output will  */
/*    be stored.  The data stored in this pointer will only be valid if the   */
/*    function returns 'CLIAUTH_UI_ARGS_PARSE_RESULT_SUCCESS'.                */
/*                                                                            */
/* args -                                                                     */
/*    An array of strings which represent the input arguments from the        */
...
/*----------------------------------------------------------------------------*/
/* Return value -                                                             */
/*    An enum representing the output state of the parsed arguments in        */
/*    'payload'.                                                              */
/*----------------------------------------------------------------------------*/
enum CliAuthUiArgsParseResult
